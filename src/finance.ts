...
export type EntryKind='refit'|'refit-sale'|'donation'|'shore-leave'|'training'|'medical'|'equipment'|'purchase'|'sale'|'wages'|'provisions-used'|'spoilage'|'materials-used'|'confiscation'|'repairs'|'recruiting'|'lodging'|'permit'|'contact'|'preparation'|'quest'|'fine'|'ransom'|'loot'|'ship-purchase'|'ship-sale'|'recovery';
export const ENTRY_NAMES:Record<EntryKind,string>={refit:'Ship outfitting','refit-sale':'Outfitting buyback',donation:'Parish donation','shore-leave':'Shore leave',training:'Crew training',medical:'Medical care',equipment:'Captain equipment',recovery:'Rescue and recovery',purchase:'Cargo purchase',sale:'Cargo sale',wages:'Crew wages','provisions-used':'Provisions consumed',spoilage:'Spoilage','materials-used':'Repair materials',confiscation:'Confiscated purchases',repairs:'Shipyard bill',recruiting:'Recruitment',lodging:'Lodging',permit:'Trade permit',contact:'Smuggler introduction',preparation:'Food preparation',quest:'Quest payment',fine:'Inspection fine',ransom:'Pirate payment',loot:'Encounter proceeds','ship-purchase':'Ship purchase','ship-sale':'Ship sale'};
...
const CASH_COSTS:EntryKind[]=['refit','refit-sale','donation','shore-leave','training','medical','equipment','wages','repairs','recruiting','lodging','permit','contact','fine','ransom','recovery'];
