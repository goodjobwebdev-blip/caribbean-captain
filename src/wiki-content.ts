...
export const WIKI:WikiArticle[]=[
 ...
 {id:'boarding',category:'Sailing and ships',title:'Deck Battle and Captain Duel',paragraphs:[
  ...
  'Surrender, incapacitation, collapse and death save a complete outcome and stop at Capture Resolution. Prizes, imprisonment and ship transfers are not yet implemented, so that voyage stays paused. A church checkpoint can restore an earlier chapter.'
 ]},
 ...
 {id:'future',category:'Getting started',title:'What is not implemented yet',paragraphs:[
  ...
  'Capture Resolution, cannon installation, detailed weapon catalogs, more perishable goods, and season-dependent sailing remain future features. Combat skill inputs are supported, but new training and reward paths beyond Sailing and Trade are not introduced by the battle release.',
