...
export const WIKI:WikiArticle[]=[
 ...
 {id:'ships',category:'Sailing and ships',title:'Buying ships and hiring crew',paragraphs:[
  ...
  'At the Tavern, hiring one sailor costs 25 silver and one hour. Dismissing one sailor is free but takes one hour, and cannot reduce crew below the ship’s minimum. Officers, fleets and capturing ships are not implemented yet.'
 ]},
 {id:'encounters',category:'Sailing and ships',title:'Pirates and the 2d6 encounter rolls',paragraphs:[
  'Every port-to-port departure rolls two six-sided dice. A total of 2 brings a pirate encounter halfway through the voyage; other totals give clear passage. At the encounter choose Flee, Negotiate or Fight, then roll 2d6 again.',
  'The result bands are 2–6 setback, 7–9 partial success and 10–12 success. Hull damage below is a percentage of maximum hull. Failure follows if the ship has no hull left or too few crew survive to operate it. Otherwise the voyage continues.',
  'This is the current simplified battle system. Cannon layout, ammunition choices and hull protection do not yet modify these rolls.'
 ],table:{headers:['Choice','2–6','7–9','10–12'],rows:[['Flee','25% hull damage; +24 hours','10% hull damage; +8 hours','No damage or delay'],['Negotiate','Demand: 150 silver','Demand: 60 silver','No demand'],['Fight','50% hull damage; lose 3 crew','20% hull damage; lose 1 crew; gain 60 silver','5% hull damage; gain 150 silver']]},tips:['If you cannot pay a negotiation demand in full, the pirates take the available silver and inflict 15% hull damage.','Encounter delays use food and wages, and spoil fruit, but do not earn extra Sailing practice.']},
 ...
 {id:'future',category:'Getting started',title:'What is not implemented yet',paragraphs:[
  'The current game focuses on sailing, trade, supplies and a single ship. Fleets, captured ships, officers, treasure maps, beaches, changing flags and a navigable visual world map are future features.',
  'Tactical naval combat, ammunition consumption, cannon installation, medicine and injury treatment, more perishable goods, and season-dependent sailing are not active. Hull protection and cannon layouts are listed for future combat, but do not modify the present 2d6 outcomes.',
