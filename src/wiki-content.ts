...
export const WIKI:WikiArticle[]=[
 ...
 {id:'contracts',category:'Work and skills',title:'Building commissions and donations',paragraphs:[
  ...
  'Churches offer passage for two monks, who use berths, weight and two provisions per day. Pharmacies provide 20 sealed units of medical supplies. Garrisons provide 40 sealed units of ammunition and gunpowder for another garrison of the same nation. Sealed freight cannot be traded, used as medicine or fired, and needs no market permit.',
  'Governors offer one rotating same-nation dispatch destination per day. Dispatches pay 25% more than the rounded ordinary letter payment (rounded again) and earn the ordinary letter Sailing points. Monks and new sealed freight use the ordinary passenger/freight payment formulas.',
  'Churches also request a 100-silver parish donation once per town per game day. Giving takes one hour plus crew upkeep, completes immediately without an active task slot, and grants +2 national attitude and +1 reputation, with no cash or Sailing reward. Keep enough silver and food for that hour. Donations appear in the Journal archive and Finance expenses.',
