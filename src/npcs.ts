...
export const TOPICS:Partial<Record<NpcPlace,readonly Topic[]>>={
 ...
 'Harbour Master':[topic('quests','Have you work for a reliable captain?','Accept letters, freight, or passenger commissions and deliver completed work.'),topic('permits','Let us put my papers and lookout in order.','Buy a national trade permit or a spyglass.')],
