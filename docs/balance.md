...
One predefined trading sloop: 300 hold units, 100 condition, 5 minimum / 20 maximum crew. A new captain has 800 silver, 10 crew, and 120 provisions. Crew experience, seasons, and speed effects from damage are deferred.
...
Goods and freight occupy one hold unit each; provisions occupy one each, including fractional remaining provisions. Six passenger berths are separate from the cargo hold.
...
Hire one sailor: 25 silver and 1 hour. Sleep: 8 silver and 8 hours. Repair: 2 silver per condition point; 5 points repaired per hour, rounded up. Repair restores the full ship in one action. Wages and provisions continue during these actions. Visiting locations and creating checkpoints take no time.
