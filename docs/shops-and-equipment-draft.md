...
Prices rise within a type of item, but armour and weapons cost more than comparable clothing because they serve another purpose. Tier does not itself grant a roll modifier. Tiers 3–4 are aspirational purchases: the 14,000-silver tailored cuirass costs more than a 12,000-silver Universal Sloop, while the 28,000-silver jewelled cuirass approaches a 30,000-silver Brigantine. These are comparisons with current provisional ship catalogue prices, not promises of permanent balance.
